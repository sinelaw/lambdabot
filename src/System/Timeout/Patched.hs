...
--
-- This is a version with a patch applied from
-- http://hackage.haskell.org/trac/ghc/ticket/7719
--
-- After a few GHC revs we should be able to drop this and go back
-- to System.Timeout.
--
-------------------------------------------------------------------------------
...
module System.Timeout.Patched ( timeout ) where

#ifdef __GLASGOW_HASKELL__
import Control.Concurrent
import Control.Exception   (Exception, handleJust, bracket, uninterruptibleMask_)
